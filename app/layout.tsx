...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body className={`${sans.variable} ${display.variable} ${mono.variable}`}><header><a className="brand logo-brand" href="/" aria-label="Nexavoris home"><Image src="/nexavoris-logo.png" alt="Nexavoris AI & ERP Systems" width={210} height={105} priority/></a><nav>{nav.map(([l,h])=><a key={l} href={h}>{l}</a>)}</nav><a className="nav-cta" href="/contact">Schedule a Consultation <ArrowUpRight size={16}/></a></header>{children}<footer><div className="footer-company"><a className="logo-brand footer-logo" href="/" aria-label="Nexavoris home"><Image src="/nexavoris-logo.png" alt="Nexavoris AI & ERP Systems" width={205} height={103}/></a><p>AI that understands your business. ERP that runs it.</p></div><address className="footer-contact"><span><MapPin size={16}/><span>13366 Murphy Road<br/>Stafford, TX 77477</span></span><a href="tel:+12812588000"><Phone size={16}/>281-258-8000</a><a href="mailto:info@nexavoris.ai"><Mail size={16}/>info@nexavoris.ai</a></address><span className="footer-copyright">© 2026 Nexavoris. All rights reserved.</span></footer></body></html>}
