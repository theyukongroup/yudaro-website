...
export const metadata=authorityMetadata('Terms of Use','Terms for using Yudaro public information, assessments, calculators, member tools, and consultation forms.','/terms');
export default function Page(){return <AuthorityPage eyebrow="TERMS OF USE" title="Use planning tools as guidance—not a guarantee." intro="These terms govern use of the Yudaro website. A signed agreement, not this website, defines any paid implementation or advisory engagement." sections={[
