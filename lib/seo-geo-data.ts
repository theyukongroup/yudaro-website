...
export const strategicKeywords = [
  ['Yudaro','Branded','/','High'],['Yudaro AI','Branded','/','High'],['Yudaro AI ERP','Branded','/','High'],['Yudaro ERP','Branded','/','High'],['Yudaro Private AI','Branded','/ai-solutions','High'],
...
export const importantRoutes = ['/','/ai-solutions','/erp-solutions','/website-design','/ai-erp','/equipment','/industries','/pricing','/about','/contact','/free-account','/assessment','/resources','/resources/private-ai','/resources/odoo-erp','/resources/ai-erp','/resources/business-automation','/resources/comparisons','/resources/guides','/resources/industries/wholesale-distribution','/resources/industries/hvac-field-service','/resources/industries/restaurants','/case-studies','/how-yudaro-works','/trust'];
